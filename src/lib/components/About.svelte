...
<section id="about" class="py-20 bg-surface-soft" bind:this={section}>
    <div class="container mx-auto px-6">
        <h2 class="animate-element text-3xl md:text-4xl font-bold mb-16 text-center text-ink-deep">
            About Me
        </h2>

        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/3 mb-10 md:mb-0 flex justify-center animate-element">
            ...
            <div class="md:w-2/3 md:pl-16">
                <h3 class="animate-element text-2xl font-bold mb-4 text-ink-deep">My Story</h3>
                <p class="animate-element mb-6 text-base text-ink leading-relaxed">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    <div class="animate-element bg-canvas p-6 rounded-2xl border border-hairline-soft shadow-sm">
